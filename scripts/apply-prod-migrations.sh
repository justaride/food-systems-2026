...
#
# Never replace this with a raw SQL directory loop: existing databases must be
# baselined/reconciled explicitly instead.
set -eu
...
# migration credential only inside this child process.
