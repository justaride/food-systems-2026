...
function main(): void {
  ...
  const mdLines = [
    ...
    '',
    `- **SourceDoc-lokatorer:** ${groupCounts['E: missing SourceDoc']?.total ?? 0} funn. Dette er strukturerte SourceDoc-poster som mangler lokal filkobling eller må få oppdatert filename/URL.`,
