...
const expectedAcceptedJobIds = new Set([
  "job:library-analysis-agent:5dbc4d81a1c11b6ec39bdb0195632ca77123fc4b81f80c623c3ec733f6b76656",
...
for (const responsePath of responsePaths) {
  const response = readJson<{ jobId: string; claims: Array<{ contentUnitId: string; localOrdinal: number }>; responseHash: string }>(responsePath);
