...
const companies: CompanyData[] = [
  ...
  },
  {
    ...
    shareholders: [
      { name: 'Too Good To Go ApS (Danmark)', ownershipPct: 100, shareholderType: 'foreign', isControlling: true },
    ],
    boardMembers: [
  ...
  },
  {
    ...
    valueChainStage: 'retail',
    shareholders: [
      { name: 'Oda Midco AS / Softbank, Kinnevik m.fl.', ownershipPct: 100, shareholderType: 'institutional', isControlling: true },
    ],
    boardMembers: [
...
const nordicCompanies: CompanyData[] = [
  ...
  },
  {
    ...
    boardMembers: [
      { personName: 'Kerstin Wallentin', role: 'styrelseordförande' },
      { personName: 'Karl Anders Torell', role: 'CEO' },
      { personName: 'Meta Persdotter', role: 'styremedlem' },
      { personName: 'Ronnie Wångdahl', role: 'vice ordförande' },
      { personName: 'Lena Rökaas', role: 'styremedlem' },
      { personName: 'Eva Karlsson', role: 'styremedlem' },
      { personName: 'Tobias Svensson', role: 'styremedlem' },
      { personName: 'Malin Sundström', role: 'styremedlem' },
      { personName: 'Michael Olander', role: 'styremedlem' },
    ],
  },
  {
    ...
    boardMembers: [
      { personName: 'Juan Aranols', role: 'CEO Lidl Sverige' },
      { personName: 'Johan Augustsson', role: 'CFO' },
      { personName: 'Magnus Edlund', role: 'styremedlem' },
      { personName: 'Anna Lund', role: 'styremedlem' },
      { personName: 'Erik Peters', role: 'styremedlem' },
    ],
  },
  ...
  },
  {
    ...
    boardMembers: [
      ...
      { personName: 'Thomas Axen', role: 'bestyrelsesmedlem' },
      { personName: 'Jesper Lauridsen', role: 'bestyrelsesmedlem' },
      { personName: 'Frank Hansen', role: 'bestyrelsesmedlem' },
      { personName: 'Kristina Olsson', role: 'bestyrelsesmedlem' },
      { personName: 'Magnus Reitan', role: 'bestyrelsesmedlem' },
    ],
  },
  {
    name: 'Dagrofa A/S',
    ...
    shareholders: [
      ...
      { name: 'KFI Erhvervsdrivende Fond', ownershipPct: 42, shareholderType: 'foundation', isControlling: false },
      { name: 'Selvstændige købmænd', ownershipPct: 9.1, shareholderType: 'private', isControlling: false },
    ],
    boardMembers: [
      { personName: 'Tomas Pietrangeli', role: 'CEO' },
      { personName: 'Martin Bruun', role: 'bestyrelsesformand' },
      { personName: 'Anders Jensen', role: 'bestyrelsesmedlem' },
      { personName: 'Lise Kaae', role: 'bestyrelsesmedlem' },
      { personName: 'Christian Bilde', role: 'bestyrelsesmedlem' },
      { personName: 'Knut Haakon Hollevik', role: 'bestyrelsesmedlem' },
    ],
  },
  ...
  // === FINLAND ===
  {
    ...
    boardMembers: [
      { personName: 'Hannu Krook', role: 'hallituksen puheenjohtaja' },
      { personName: 'Harri Miettinen', role: 'varapuheenjohtaja' },
      { personName: 'Minna Lindholm', role: 'hallituksen jäsen' },
      { personName: 'Taavi Heikkilä', role: 'toimitusjohtaja' },
      { personName: 'Matti Niemi', role: 'hallituksen jäsen' },
      { personName: 'Arttu Laine', role: 'hallituksen jäsen' },
      { personName: 'Sari Björkqvist', role: 'hallituksen jäsen' },
      { personName: 'Minna Alitalo', role: 'hallituksen jäsen' },
    ],
  },
  {
    name: 'Kesko Oyj',
  ...
  },
  {
    ...
    boardMembers: [
      { personName: 'Nicholas Pennanen', role: 'CEO Lidl Suomi' },
      { personName: 'Lauri Sipilä', role: 'hallituksen jäsen' },
      { personName: 'Satu Wähälä', role: 'hallituksen jäsen' },
      { personName: 'Kimmo Mattila', role: 'CFO' },
    ],
  },
  ...
  },
  {
    ...
    boardMembers: [
      ...
      { personName: 'Auður Daníelsdóttir', role: 'CEO' },
      { personName: 'Magnús Ingi Einarsson', role: 'stjórnarmaður' },
      { personName: 'Thordis Kolbrun Reykfjord Gylfadottir', role: 'stjórnarmaður' },
      { personName: 'Bjarni Arason', role: 'stjórnarmaður' },
      { personName: 'Sigridur Jonsdottir', role: 'stjórnarmaður' },
      { personName: 'Kristjan Loftsson', role: 'stjórnarmaður' },
    ],
  },
  {
    name: 'Festi hf',
    ...
    shareholders: [
      { name: 'Eignarhaldsfélagið Fasteign hf', ownershipPct: 34, shareholderType: 'institutional', isControlling: true },
      { name: 'Lífeyrissjóður starfsmanna ríkisins', ownershipPct: 8, shareholderType: 'institutional', isControlling: false },
    ],
    boardMembers: [
      { personName: 'Sigurlína Ingvarsdóttir', role: 'stjórnarformaður' },
      { personName: 'Sölvi Árnason', role: 'forstjóri' },
      { personName: 'Helgi Magnússon', role: 'stjórnarmaður' },
      { personName: 'Bryndís Hlödversdottir', role: 'stjórnarmaður' },
      { personName: 'Ögmundur Kristinsson', role: 'stjórnarmaður' },
      { personName: 'Jóhanna Vigdís Gudmundsdottir', role: 'stjórnarmaður' },
    ],
  },
]
