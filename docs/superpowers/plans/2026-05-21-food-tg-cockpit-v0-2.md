...
export const foodTgCandidateCards: FoodTgCandidateCard[] = [
  {
    ...
    minimumData: ['modenhet', 'kost', 'LCA', 'råvaregrunnlag', 'regulatorisk vei', 'kjøperkrav', 'aktørdata'],
  ...
  },
  {
    ...
    minimumData: ['tonn/år', 'batch', 'fukt', 'temperatur', 'mikrobiologi', 'nåværende avsetning', 'logistikk', 'sluttbruk'],
