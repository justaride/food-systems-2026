...
| Queue-ID | Tema | Konkret sjekk | Nåværende kilde/status | Trengs fra primærkilde | Berører | Eier | Status |
|---|---|---|---|---|---|---|---|
| PCQ-MAKT-001 | AP-5 ultimate ownership | Verifiser topp-konsernenes juridiske form + kontrollpersoner mot Brønnøysund; krysssjekk eierandel-%. | Form + styrekontroll bekreftet for 8 konsern + 6 sjømat/Møgster-selskaper (22/22 formmatch) mot `/enheter` + `/roller` 2026-06-14. Eierandel-% verifisert mot offentlige primærkilder 2026-06-15: eier-identitet matcher for alle 9; topp-andel primærkildebelagt for 6; NG/Johannson >74 % via SNL; Reitan/ASKO 100 % strukturelt sikkert men inferert. Lokal operator-sekvens grønn 2026-06-15 (`db:audit:strict-sources` 0 brudd, P0=0). | **BAMA-splitten lukket 2026-08-24** fra selskapets egen årsrapport (note 15): NorgesGruppen 46 %, Banan II 34 %, Rema Industrier 20 % pr. 31.12.2023 — den tidligere ~46/46-inferensen var feil. Valgfritt restspor: Aksjonærregister-uttrekk for fullt register-kryss; ikke blokker for `citable_with_note`. | CL-AP5-001, CL-MAKTKART-001 | Gabriel | checked; `citable_with_note`, BAMA-forbeholdet lukket |
...
**Masterbeslutning 2026-06-15:** CL-AP5-001 og CL-MAKTKART-001 er løftet til `citable_with_note` for *strukturpåstanden* (hvem kontrollerer via form/styre/eierandel-%). AP-1-styrebroer brukes ikke alene som ekstern faktastemme, men inngår i trianguleringen. Aksjonærregisteret er fortsatt nyttig for register-kryss og BAMA-split, men er ikke lenger hard blokk etter offentlige primærkilder + grønn operator-sekvens.
