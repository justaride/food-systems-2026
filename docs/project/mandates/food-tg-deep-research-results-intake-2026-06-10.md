...
72t kilde-/datakontrollen ligger i `food-tg-primarkilde-og-datakontroll-ledger-2026-06-10.md`, og samlet go/no-go ligger i `food-tg-research-intake-decision-pack-2026-06-10.md`.
...
>
> **Repo-sikring 2026-06-13:** 12.06-resultatene er deduplisert som ti unike `DRR-1206-*`-filer i `research/external/dro-1206/`, med kontrollnotat i `docs/project/analysis/case-avsjekk/mottak-deep-research-1206-2026-06-13.md`. Fire etterfølgende case-avsjekk-prompter er lagret i `docs/project/analysis/case-avsjekk/`. De åpner ikke claims alene; de flytter konkrete kildekandidater og stoppsignaler til PCQ/source-shortlist/claim-lock i protokollrekkefølge.
...
## Case-avsjekk-promptresultater 2026-06-13

| Resultat-ID | Prompt | Outputfil | Knyttet DRO/PCQ/SRC | Kontrollstatus | Importbeslutning | Neste handling |
|---|---|---|---|---|---|---|
| CAP-1306-001 | `P-FISH-1` + `P-SKOT-2` | `docs/project/analysis/case-avsjekk/deep-research-fish-p-fish-1-p-skot-2-2026-06-13.md` | `DRO-0906-006`, `PCQ-B-005`, `SRC-B-027`, `SRC-A-017`, `SRC-0906-012`, `SRC-1306-001` til `SRC-1306-002` | Delvis lukket; volum/struktur lukket, råfraksjonspris ikke funnet | Importer som intern verdimiks-/strukturdelta med caveat. HS-enhetsverdier er produktproxy, ikke råfraksjonspris. | Oppdater PCQ-B-005; hold `P-FISH-1B` som eventuell smal prisgate. |
| CAP-1306-002 | `P-DIST-1` | `docs/project/analysis/case-avsjekk/deep-research-dist-p-dist-1-2026-06-13.md` | `DRO-0906-004`, `PCQ-0906-004`, `SRC-0906-004`, `SRC-1306-003` til `SRC-1306-005` | Delvis lukket; RP-06-ledger mulig, månedstall/aktørvilkår åpne | Importer som intern ledgerkandidat med `ikke aktøranklage`. | Oppdater PCQ-0906-004; ikke start bred aktørjakt før RP-06 viser om ledgeren er nok. |
| CAP-1306-003 | `P-FISH-2` | `docs/project/analysis/case-avsjekk/deep-research-fish-p-fish-2-2026-06-13.md` | `DRO-0906-006`, `PCQ-B-005`, `SRC-0906-014` | Stoppsignal; Strand et al. 2024 mangler lokalt | Importer som gapnotat. Ingen metodebro Island-Norge kan lukkes. | Hent fulltekst og kjør P-FISH-2 på nytt. |
| CAP-1306-004 | `P-VALIO-1` | `docs/project/analysis/case-avsjekk/deep-research-valio-p-valio-1-2026-06-13.md` | `DRO-0906-003`, `PCQ-0906-006`, `SRC-0906-006`, `SRC-1306-006` til `SRC-1306-008` | Lukket for nasjonalt datasettgrunnlag; ikke Valio-spesifikk fôrkurv | Importer som intern systemramme for Finland/Valio med caveat. | Oppdater PCQ-0906-006; hold Valio fôrkurv/PFAD/A-Rehu i DASK/AASK. |
