...
endringslogg:
  - 2026-09-15 Lagt til SRC-1509-001 (Eurostat Comext-uttrekk for kakao, EU-omveien) og oppdatert SRC-C-018 med EUDR-status per 15.09.2026. Mottak: docs/project/analysis/case-avsjekk/mottak-eudr-v6-kontroll-2026-09-15.md. Ingen rad er ekstern faktastemme.
...
| SRC-C-018 | European Commission EUDR-side, EUR-Lex 2023/1115 og 2025/2650, regjeringen.no/Miljødirektoratet høringer/statussider, Landbruksdirektoratet EUDR-side/FAQ og EØS-notater | primær | C-adoption, policy, A-feed | EUDR-kildepakke for EU-scope, soya, avskogingsfri dokumentasjon, due diligence, EU-frister og norsk/EØS-status. Oppdatert 2026-05-21: Landbruksdirektoratet sier EUDR ikke er innlemmet i EØS/norsk rett ennå og at jordbruksvarer som storfekjøtt og soya holdes utenfor delvis norsk gjennomføring; Miljødirektoratet sier forskriftsutkastet er til departementsbehandling og norsk ikrafttredelse ikke er avgjort. Endelig Lovdata/EØS-/Traces-status og aktørpraksis må fortsatt sjekkes. Oppdatert 2026-09-15: Landbruksdirektoratet (sist oppdatert 16.07.2026) sier fortsatt at forordningen ikke er innlemmet i EØS-avtalen og norsk rett. Høringsnotatet fra 19.08.2025 tar med all kaffe (HS 0901) og kakao HS 1803–1806, men ikke HS 1801–1802. EU-datoene 30.12.2026 og 30.06.2027 står (2025/2650; COM(2026) 191). En delegert rettsakt om vedlegg I ble vedtatt 13.07.2026; kunngjøring i EUT er ikke verifisert. Locators: `docs/project/analysis/case-avsjekk/mottak-eudr-v6-kontroll-2026-09-15.md`. |
...
| SRC-1509-001 | Eurostat Comext `ds-045409` («EU trade since 1988 by HS2-4-6 and CN8»), API-uttrekk 12.06.2026: eksport fra NL/BE/DE til NO/SE/DK/FI, HS 1801–1806, 2022–2024. Lokal CSV: `research/external/dro-0906/eurostat-comext-cocoa-nl-be-de-to-nordics-hs1801-1806-2022-2024.csv` (195 rader, SHA-256 `9ab646357ef4da493ecccc29cd57a4a69696037f58778e9f4d132d6bd62d466d`). API: `https://ec.europa.eu/eurostat/api/comext/dissemination/statistics/1.0/data/ds-045409` | primær (API-uttrekk) | C-adoption, baseline | Kvantifiserer EU-omveien for kakao (2024: 121 038 t / 968 MEUR). Etterregnet og stikkprøvet mot API 15.09.2026. Speiltall fra EU-eksportør med alle opprinnelser, så CI-andelen kan ikke leses ut. Bare tre avsenderland. Internt tallgrunnlag; ingen ekstern faktastemme uten claim-lock. Logg: uttak-09 F2-3. Mottak: `docs/project/analysis/case-avsjekk/mottak-eudr-v6-kontroll-2026-09-15.md`. |
...
| SRC-1509-001 | Comext-speiltall kan avvike fra SSB, dekker bare NL/BE/DE og viser ikke opprinnelsesland. Må ikke brukes som CI-volum eller som «EUDR-pliktig volum i Norge», siden HS 1801–1802 er utenfor det norske forslaget. | Gabriel | Ved valg av V6 |
