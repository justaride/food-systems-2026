...
|---|---|---|---|---|
| 2026-05-21 | Bekreft A+B som hovedscope med C som tverrgående gate, eller gi minimumsvedtak for begrenset valideringssprint. | JTO/Cathrine/Einar | Venter bekreftelse | `food-tg-scope-decision-request-2026-05-21.md` |
