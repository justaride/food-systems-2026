...
| KI-kunnskap | Nytt skrivebeskyttet uttrekk av alle 1770 klassifiseringer og en hashbundet inputpopulasjon. 1610 har lesbart, hashbundet input; 160 har inputhindre. Eldre pilotkjøring kontrollert separat. | Ingen kandidatkjøringer eller menneskelige vedtak i produksjon. Input-egnethet er ikke validert analyse. Se SOURCE-WORK.md. |
