...
Sist oppdatert: 2026-07-19. Eier-repo: `justaride/food-systems-2026`.
...
```
  Utvikler (Mac)                         GitHub Actions
   ...
   │                                       │     (manuell, read-only)        │ 77.42.43.227:8000 [V]
...
`COOLIFY_API_TOKEN`, `COOLIFY_READ_API_TOKEN`, `COOLIFY_BASE_URL`
(`http://77.42.43.227:8000`),
