...
- `npx tsx scripts/link-nordic-core-sourcedocs.ts --apply`
- `npx tsx scripts/apply-reviewed-insight-slug-links.ts --dry-run`
- `npx tsx scripts/apply-reviewed-insight-slug-links.ts`
...
2. Fortsett med liten, reviewet slug-ledger for gjenværende archived seed-rader; ikke importer gamle seed-rader i bulk.
