...
- Dette bekrefter bare at live `main` og deploy-kjeden er oppe gjennom seneste status-sync. PR #159-stackens nye `/api/data-status`-dekning, ~275-selskapsavstemming, prod-import og operatorsekvens venter fortsatt på G-06/G-10/G-11-vedtak, merge og Fase B.
