...
|---|---:|---|---|---|
| `codex/ai-kunnskap-library-v1` | 148 | `215 0` | Core/cockpit portet og merget i PR #283; read-only repair-backlog, locator-profile og extraction-profile portet; fortsatt ingen PR/remote branch for resten. | Behold. Status er fortsatt 60 modified + 88 untracked fordi worktree-en står på en eldre branchbase, men core-filene, repair-backlog-generatoren og de read-only profilgeneratorene er nå skilt ut på `main`. Gjenværende verdi ligger i uncommitted pipeline-/dataarbeid: library-analysis inventory/process/apply/reparasjonsscripts, generated `research/_status/library-analysis*` og `research/_status/library-triage/`, samt kildekuratering i `research/bibliotek/**`, `research/evidence-pack/**`, `research/landbrukarena_transcripts/**` og `research/regulatory/**`. Trenger egen port/drop-beslutning per kategori før sletting. |
