...
|---|---:|---|---|---|
| `codex/ai-kunnskap-library-v1` | 148 | `215 0` | Core/cockpit portet og merget i PR #283; read-only inventory/ledger, repair-backlog, locator-profile og extraction-profile portet; fortsatt ingen PR/remote branch for resten. | Behold. Status er fortsatt 60 modified + 88 untracked fordi worktree-en står på en eldre branchbase, men core-filene og de read-only analyse-/profilgeneratorene er nå skilt ut på `main`. Gjenværende verdi ligger i uncommitted pipeline-/dataarbeid: library-analysis process/apply/reparasjonsscripts, generated `research/_status/library-analysis*` og `research/_status/library-triage/`, samt kildekuratering i `research/bibliotek/**`, `research/evidence-pack/**`, `research/landbrukarena_transcripts/**` og `research/regulatory/**`. Trenger egen port/drop-beslutning per kategori før sletting. |
...
3. For `codex/ai-kunnskap-library-v1`: behandle restene som separate beslutninger: process/apply/reparasjonsscripts, generated `research/_status` artifacts, kildekuratering, og gjenværende package-script wiring. Ikke slett eller reset hele worktree-en bare fordi core/cockpit og read-only analyse-/profilgeneratorer er landet.
