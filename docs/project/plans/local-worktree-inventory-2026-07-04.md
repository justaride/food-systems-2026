...
|---|---:|---|---|---|
| `codex/ai-kunnskap-library-v1` | 148 | `215 0` | Core/cockpit portet og merget i PR #283; read-only repair-backlog-generator portet; fortsatt ingen PR/remote branch for resten. | Behold. Status er fortsatt 60 modified + 88 untracked fordi worktree-en står på en eldre branchbase, men core-filene og repair-backlog-generatoren er nå skilt ut på `main`. Gjenværende verdi ligger i uncommitted pipeline-/dataarbeid: de øvrige package-scriptene, library-analysis inventory/process/apply/profil-/reparasjonsscripts, generated `research/_status/library-analysis*` og `research/_status/library-triage/`, samt kildekuratering i `research/bibliotek/**`, `research/evidence-pack/**`, `research/landbrukarena_transcripts/**` og `research/regulatory/**`. Trenger egen port/drop-beslutning per kategori før sletting. |
...
3. For `codex/ai-kunnskap-library-v1`: behandle restene som separate beslutninger: inventory/process/apply/profil-/reparasjonsscripts, generated `research/_status` artifacts, kildekuratering, og gjenværende package-script wiring. Ikke slett eller reset hele worktree-en bare fordi core/cockpit og read-only repair-backlog er landet.
