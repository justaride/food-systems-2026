...
3. For `codex/master-research-plan-2026-07-01`: fortsett med smale port/drop-slices. Neste vurdering bør starte med de gjenværende kode-/testfilene (`citable-acceptance`, `import-research-docs`, nye databackfill-scripts) før de store MVK/R13-forskningsartefaktene. Ikke slett eller reset fordi arbeidet fortsatt er uncommitted.
