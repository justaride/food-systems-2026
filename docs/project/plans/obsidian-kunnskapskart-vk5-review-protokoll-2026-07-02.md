...
| Review-preflight | `npm run vault:review-preflight` | Alle repo-/vault-stier, masterplanens obligatoriske frontmatter, `relaterte_filer`-mål, kontraktseksjoner, akseptanse-/invarianttekst, `.claude/source-attribution-policy.md`-målet, VK-5-protokollfrontmatter-mål, VK-5-frontmatter-koblinger og -mål, I27+-frontmatter-mål, I27+-stopptekst og anti-overclaim-statusverdier finnes | ikke sjekket i review |  |
