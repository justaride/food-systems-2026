...
| AP-5 konsern | `klar-med-forbehold (citable_with_note)` | Form, styrekontroll og eierandel-% primærsjekket (§6b, ni av ni konsern mot IR-/årsrapport). Restforbehold: Reitan/ASKO 100 % inferert. BAMA-splitten er lukket (§6c: 46/34/20, ingen flertall) | `...ap5-krysseie...`, `...maktkart-bronnoysund-stikkprove...` |
