...
- VK-2 I27+ generering: menneske ma godkjenne eller redigere kandidatlisten for I27-I38 for nye innsiktsnoter genereres.
- `vault:check` skal være gronn etter eventuell I27+-beslutning/generering; pending kandidater kan ikke ligge som I27+-noter i vaulten.
...
- `node --import=tsx --test tests/lib/obsidian-vault.test.ts tests/lib/obsidian-vault-export.test.ts tests/lib/package-scripts.test.ts` - pass, 80 tester.
