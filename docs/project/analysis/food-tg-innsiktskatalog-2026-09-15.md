...
> **Status:** Intern arbeidsliste. Katalogen erstatter ikke kildefilene, Obsidian-registeret (`Food Systems Obsidian/10 Innsiktskart/Innsikter/`) eller claim-lock. Statusen er slik kildefilene og kontrollstakken oppgir den per 15.09.2026. Ingen status er hevet her. Ingen ny kildekontroll er gjort, med ett unntak: SI-06 til SI-09 er sjekket mot primærkilder 15.09.2026 (`docs/project/analysis/case-avsjekk/mottak-eudr-v6-kontroll-2026-09-15.md`). Der kildefilene er innbyrdes uenige, står det i del 5. «Siterbar» betyr at funnet har gått gjennom siteringskjeden i prosjektet. Forbeholdet i kilden gjelder fortsatt, og ekstern bruk krever redaksjonell kontroll og kildepolicy.
>
...
| SI-06 | Kaffe: Brasils andel av norsk råkaffeimport har økt, prisen steg kraftig fra 2024 til 2025, og Brasil er «standard risk» under EUDR. | Kontrollert internt | desk-loggen kap. 3; `analysis/case-avsjekk/avsjekk-01-kaffe-brasil-2026-06-12.md`; `analysis/case-avsjekk/mottak-eudr-v6-kontroll-2026-09-15.md` E5 | V6 | Prisøkningen er avledet av Comtrade-preview, ikke et kildetall. Aldri «lavrisiko». Risikoklassen er sjekket mot EU-listen 15.09.2026. |
| SI-07 | EUDR er ikke innlemmet i EØS-avtalen eller norsk rett (Landbruksdirektoratet, sist oppdatert 16.07.2026). Ingen norsk dato er satt. | Kontrollert internt | mottaksnotatet E6–E7; avsjekk-01 #4; dybdeauditen §6.1 | V6 | Tidskritisk. Sjekket mot primærkilder 15.09.2026. Norsk ikrafttredelse krever EØS-komiteen og Stortinget. «Kaffe er innlemmet» er rettet (`f556778`) og står på hold-tilbake-listen i claim-lock. |
| SI-08 | Kakaobønner, -skall og -avfall (HS 1801–1802) er utenfor det norske forslaget til EUDR-forskrift, mens kakaomasse, -smør, -pulver og sjokolade (HS 1803–1806) er med. I EU leverer den som først plasserer varen på markedet, aktsomhetserklæringen, fra 30.12.2026 for store og mellomstore. | Kontrollert internt | avsjekk-02 #6–7; mottaksnotatet E1, E3 og E8 | V6 | Tidskritisk. Den norske delen er et høringsforslag fra 2025, ikke vedtatt rett. 30.12.2026 er EU-datoen, ikke norsk dato. En norsk vinkel få andre formidler. |
| SI-09 | Norden importerer ikke kakao direkte fra Elfenbenskysten; eksponeringen ligger i EU-leddet. | Kontrollert internt (nullfunn om direkteimport) | avsjekk-02 #1 og #3; Comext-uttrekket `SRC-1509-001`; mottaksnotatet §3 | V6 | EU-omveien (121 038 t fra NL, BE og DE i 2024) er etterregnet og registrert, men er fortsatt internt tallgrunnlag. Tallene gjelder alle opprinnelser, så CI-andelen kan ikke leses ut. |
...
| BE-18 | Bondemargin (N11): bytteforholdet mellom kostnads- og inntektspriser var 4–7 prosent svakere hvert år 2017–2023 enn i 2024 (forholdstall 1,044–1,071, 2024 = 100), og andelen markedsinntekt har falt. | Siterbar | `research/external/r6/DRO-R6-INDEX-2026-06-18.md` | H, V9 | Normalisert kalkyle, ikke driftsregnskap. Ulike inntektsmål må ikke blandes; se merknaden i R6- og R12-filene (15.09.2026). Ikke «5–7 prosentpoeng»: differansen er 3,1–5,8 indekspoeng (N11 Tabell 2.15-utdraget, rettet 18.09.2026; se del 5). Viser ikke at kostnadene steg raskere hvert år; se P-011 i hvitbokens påstandsregister. |
| BE-19 | Gjødselsjokket 2021–2023 og et realfall i inntekt per årsverk i 2023. Laveste driftsformer ligger langt under sammenligningslønn. | Siterbar | samme | H, V9 | BFJ har senere justert 2023-tallet. Fallet i 2023 skyldes i stor grad renteoppgangen, ikke bare gjødsel (kontroll mot UT-1-2026, `research/whitepaper/v3/kontroll-v9-ut-1-2026.md`, 18.09.2026, kontrollert internt). |
...
- **Bondeøkonomi i hashbundne filer:** R6-indeksen (`research/external/r6/DRO-R6-INDEX-2026-06-18.md`, «Kort dom») sier «5–7 pp» og «skvis-ratio 1,06–1,07», og N11-filen (`research/external/r6/deep-research-r6-n11-bondemargin-2026-06-18.md`, «Tolkning» under Tabell 2.15) sier «~1,06–1,07». Tabellen i samme fil gir forholdstall 1,044–1,071 (4–7 prosent over) og en differanse på 3,1–5,8 indekspoeng for 2017–2023. Begge filene er låst med innholds-hash i korpusregisteret og er ikke endret. Riktig lesning står i BE-18 og i hvitbokens P-011.
...
| V6 | EUDR-treffkartet | SI-06, SI-07, SI-08, SI-09 | Kontrollert internt | Tidskritisk mot 30.12.2026. Comext-tallene er registrert (`SRC-1509-001`). Gjenstår: norsk forskrift og dato, etterslepet i del 5 og claim-lock før ekstern bruk |
...
| V9 | Hvor sjokket lander (bondeøkonomi) | BE-18, BE-19 | Siterbar. Tallene om tilskudd, markedsinntekt og renter er kontrollert internt (18.09.2026) | Margin per kilo krever aktørdata. Vinkelen er skrevet om til «staten tok kostnadssjokket, renten traff gården» |
