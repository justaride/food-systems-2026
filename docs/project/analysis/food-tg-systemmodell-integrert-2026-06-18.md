---
tittel: Food TG — Integrert systemmodell (kausalkart over R2–R5)
status: Analytiker-syntese v0.1 — FORSTÅELSE, ikke faktastemme
eier: Gabriel
dato: 2026-06-18
type: analyse/syntese (ikke datasøk; ingen nye claims)
scope: >
  Monterer de dokumenterte funnene fra runde 2–5 til én eksplisitt kausalmodell: noder, strømmer og
  tilbakekoblinger. Målet er å gå fra delekatalog til motor — å vise hva som driver hva, hvilke sløyfer
  som låser systemet, og hvor modellen mangler input (blindsonene). Den avslører hvilke manglende brikker
  som faktisk betyr noe for helheten, i stedet for å gjette.
bruksregel: >
  FORSTÅELSE — ikke faktastemme. Alle node-tall er allerede dokumentert (med forbehold) i de refererte
  filene; ingen åpnes som ny claim her. Kausalpilene er analytiske hypoteser, ikke målt kausalitet — de
  skal merkes som syntese ved ekstern bruk. Wageningen-guardrail gjelder.
relaterte_filer:
  - research/external/r4/DRO-R4-INDEX-2026-06-18.md
  - research/external/r5/DRO-R5-INDEX-2026-06-18.md
  - research/forstaelse/forstaelse-r4-17-2026-06-18.md
  - research/forstaelse/forstaelse-r4-19-2026-06-18.md
  - research/forstaelse/forstaelse-r4-20-2026-06-18.md
  - research/forstaelse/forstaelse-r4-21-2026-06-18.md
---
...
- **N11 Bondeøkonomi/arbeid** — *delvis dekket (DRO-R6-N11, 2026-06-18)*: kostnads-pris-skvisen er nå tallfestet (bytteforholdet mellom BFJs kostnads- og inntektsprisindeks 4–7 % svakere hvert år 2017–2023 enn i 2024, forholdstall 1,044–1,071 med 2024 = 100 — rettet 2026-09-18, sto «5–7 pp over»; laveste ammeku 33 % av sammenligningslønn og sauebruk 38–74 %; 2022–23-gjødselsjokk +127 %, realfall 75 200 kr/årsverk 2023). Gjenstår B: per-kg-margin etter kjøperprisavtale (aktørdata).
...
```mermaid
flowchart TB
  subgraph INPUT["INPUT-lag (tynt/blindt)"]
    N7["N7 Etterspørsel/forbruk<br/>BLIND"]:::blind
    N8["N8 Kapital/finans<br/>delvis"]:::partial
  end

  subgraph STRUKTUR["STRUKTUR-lag (godt dekket)"]
    N1["N1 Importavhengighet<br/>>92% fôr, soya 69,8%"]
  ...
  N7 -.mangler.-> N3
  N8 -.delvis.-> N2
  N2 -- styrer innkjøp --> N1
  N1 -- skalafordel --> N2
  N2 --> N3
  N3 -- etableringshindring --> N4
  N4 -- ingen substitusjonspress --> N3
  N5 -- åpen næringsloop --> N1
  N3 --> N6
  N6 -. reaktiv, treffer ikke .-> N3
  N3 -- produserer --> N9
  N1 --> N10
  N5 --> N10
  N3 -- skvis --> N11

  L1(("L1 konsentrasjon↔import")):::loop
  L2(("L2 distribusjonsgate")):::loop
  L3(("L3 åpen næringsloop")):::loop
  L4(("L4 governance-impotens")):::loop
  L5(("L5 konsentrasjons-fraktal")):::loop

  classDef blind fill:#fde,stroke:#c39,stroke-dasharray:5 5;
  classDef partial fill:#ffd,stroke:#aa3;
  classDef loop fill:#def,stroke:#37a;
```
