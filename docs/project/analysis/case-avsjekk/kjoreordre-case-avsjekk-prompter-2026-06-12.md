...
| 3 | `P-FISH-2` | Leseoppgave, ikke websøk. Bruk `research/external/dro-0906/downloads/strand-etal-2024.md` som locator/source note hvis raw PDF ikke ligger lokalt. | Metodebro Island-Norge med definisjonstabell og claim-lock-forslag. | Hvis artikkelen mangler eller bruker inkompatible definisjoner, logges gapet og sammenligningen holdes tilbake. |
