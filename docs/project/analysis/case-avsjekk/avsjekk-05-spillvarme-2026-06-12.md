...
| 3 | Er Wiig-piloten (Odin/DC1, 4 MW, Vikvegen/Orre, Klepp) i drift? | Nei dokumentert: rammetillatelse nov. 2023 (Holon); Enova-prosjektside bekreftet 4 MW initielt, 50–70 °C, potensial 200 MW (desk-logg kap. 6) — siden er senere blitt 404, skjermkopi/PDF arkivert på codex-grenen (`research/external/dro-0906/downloads/enova-wiig-prosjektside-current-404-2026-06-12.pdf`). Tidslinjen er forskjøvet minst to ganger (ferdig høst 2024 → operativ jan. 2025 → «Available Q3 2026»); ingen IG/ferdigattest funnet. Kilde: uttak-03 | **DELVIS** — resten er MENNESKEGATE: ferdig innsynskrav til Klepp kommune ligger klart (uttak-03 kap. 3); skal sendes, ikke researches |
