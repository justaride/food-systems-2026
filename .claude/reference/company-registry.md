...
Existing company coverage and reference IDs for import work. Norwegian companies use numeric orgNr from Bronnoysund. Nordic companies use country-prefixed IDs such as `SE-`, `DK-`, `FI-`, and `IS-`.
