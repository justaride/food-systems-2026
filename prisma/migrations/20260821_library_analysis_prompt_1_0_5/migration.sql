    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.5'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '20b2ede397cc207f0f2c8e801a054942e6840508732ffc675126d8127470c49d'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.5'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '0be38e0064f76640cc674b8c0e546c5c7c30c783886d427f28a5b372bce99473'
        ) OR (
          ...
          AND run_row."workflowHash" = '2bb1a3ab06093bc1954771ccc982d9cffb6519858e839f7efcae34d16a782a21'
          ...
          AND run_row."promptHash" = '69409d5950e48acdc17bab83b2fd02018d3463f2e057e33d587f814fd8b02290'
        )
      )
