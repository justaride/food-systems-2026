    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.9'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '898f5c81418bfef1684c0ef459c71a1d25f94813cd501b0d0ce88ac4694f03e3'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.9'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '100611f97af95386782c588a20b1e9151d5ba115d6c61912030b510e237b3078'
        ) OR (
          ...
          AND run_row."workflowHash" = '865bb9f8018710cc61226ec51bdd2df49c28bdb84e7fb96948e802cc347fec16'
          ...
          AND run_row."promptHash" = 'd274d5d6f0201bb7ccbf4e2f32517f9920b3733b0aee27e4d7ae46d1697e4bcf'
        )
      )
