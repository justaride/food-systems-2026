    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.12'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = 'fb1f4299c9abad93fa11e42a767427d56ad802d0f29bda8e06a6317c725613f0'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.12'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '7067978a0fa2ff32b9c6a47969ee619d756ab719f1c95129f7c0d29f457718d8'
        ) OR (
          ...
          AND run_row."workflowHash" = 'a402a650205fc79e43aba76f7c5b30360d53564fb9ff778d98d1a1119e796610'
          ...
          AND run_row."promptHash" = '2b658ec2f0219e2654572155c4068e6e2e790e8cb3fc0afc2764dc0f6ef39bd5'
        )
      )
