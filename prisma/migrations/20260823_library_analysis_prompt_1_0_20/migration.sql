-- Advance the sealed library analysis and validation bindings to 1.0.20
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.20'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '706140866ba236b0055f47f066b27831343415c61fe2be900fd9205835b49cde'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.20'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '6fe88571c51f227293eb65f5e0da54592aefbfa0d775f49c1758e44d12536e9c'
        ) OR (
          ...
          AND run_row."workflowHash" = 'ddd4c70a0172f2ddc197a76b9a5a58b3f4f420b70f0f33c0264d8484f6ee5c4c'
          ...
          AND run_row."promptHash" = '8c82b8986b4955646857c16ae3f549c5c5a1ea711c8fd3d4a44f367d23b1da01'
        )
      )
