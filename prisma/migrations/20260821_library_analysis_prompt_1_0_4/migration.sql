    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.4'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '65acd3c4bf8a48b8be041fdd0d5027715ca5fc311a6313c2702a5f1017196dae'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.4'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '07f663c046acf3531bbd3c8989f75fce0a05b725633cea7ec47f6fa5241446b9'
        ) OR (
          ...
          AND run_row."workflowHash" = 'aedc6f4e6151d27e4e21c2634ad36a7024aed5a2c23fd535af26e9cc55e48335'
          ...
          AND run_row."promptHash" = '5cf1ff10e1f7b832c97a29e32cf5ffe433987b1e8c729c6e37cb725a52237ddd'
        )
      )
