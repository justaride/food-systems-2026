    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.7'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '0ddbff400b02b5710eccbc3ced040ef4e33294c37e96eec9f1dd187aaaea1d6b'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.7'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '665243c3942eddc4e12337c8e69925fff47b7242fbbcede6b90241cc8f349bcb'
        ) OR (
          ...
          AND run_row."workflowHash" = 'e042475b2194bb6c106012a6915b41a7b4fdfae24c350322d9425bf758b6a2ed'
          ...
          AND run_row."promptHash" = '2aac227eb5d5c93407ed3b700bd9f257ab876cc7872db41d6ff19e51e9354f1a'
        )
      )
