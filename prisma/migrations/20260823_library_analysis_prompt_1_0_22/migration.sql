-- Advance the sealed library analysis and validation bindings to 1.0.22
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.22'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '394b1e5fbf3d723d33b7724234d059e25122fec4e90b6d18c1af19f71cf7b342'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.22'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '7c3b84b5fc6a01648439aefd426a58b37006b4f54a090c9ad9d500b4250ee391'
        ) OR (
          ...
          AND run_row."workflowHash" = '46cc9d8b11439354f6d03686b6378d1c25658e08f1b6f0d7eddcc6c13e4b7600'
          ...
          AND run_row."promptHash" = '3350ccbad77ccf756a16f499eafe1bb00826f780c8dfe352e4fc89a71b605278'
        )
      )
