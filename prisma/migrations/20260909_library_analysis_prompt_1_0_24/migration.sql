-- Advance the sealed library analysis and validation bindings to 1.0.24
-- without rewriting prior migrations, candidate records or review decisions.
-- Only the exact workflow/prompt version and four content hashes change.
-- No grants, logins, promotion rules or candidate_only bindings are broadened.
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.24'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '5794414381dc0c90ade32eac4c36a52a49bdd203f7d93213c7a2851d3620da15'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.24'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '7dccdf2f546b2ddde693f5c361c20e6467e66a02bf11a6750ca8265271f9a2cd'
        ) OR (
          ...
          AND run_row."workflowHash" = '06c88137dd654376edb65493ac6eb041661385c578f35475036e4cf1ab55d8ec'
          ...
          AND run_row."promptHash" = '861563dbf1a9494752b8ef359a1f6b7717911942dbebe170aba0b60c9d98e0b8'
        )
      )
