    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.3'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '2caf3b7a547f1f928861ff010e1769fc3b6c08b59b3920b5a0d96152aedd0bb3'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.3'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '0a18d6d226c205da61cc3797ad31e9a09db081486a91d87143d6702c18253951'
        ) OR (
          ...
          AND run_row."workflowHash" = '033152fb899317d883a185f3efec80807588cab80530b6a7d376bc94e209c6ad'
          ...
          AND run_row."promptHash" = '1efdc6f70e6367ef6bcc793476bb3f96d53e2a67c99fee0370453db85d41d455'
        )
      )
