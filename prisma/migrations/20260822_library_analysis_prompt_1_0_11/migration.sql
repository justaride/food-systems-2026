    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.11'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '191fa9e12d1aa83b6ebf23331d670606a080b9926c25c022332046ec58d63944'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.11'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = 'e00d78605dbf43d7306e25f07f0fe595eedf9abc7dbf5f947634bff95d2f0223'
        ) OR (
          ...
          AND run_row."workflowHash" = '557cf8360993c38dba0eacffb61311d0a97749fe0007054f94e734746caa677f'
          ...
          AND run_row."promptHash" = 'f7b69cf22501a16033ed5cdcbb5e74e38e107059422a9deb3ad931a74accd38c'
        )
      )
