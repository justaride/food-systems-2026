    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.13'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '85302cc824f00e7f80f374900f7a304d8e8f3db68958de34f702a0837cf64041'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.13'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = 'b4e74d786a4ba304e4b1b4e3bc18f8da9dcbb0bf80987bedc957a3502edbea48'
        ) OR (
          ...
          AND run_row."workflowHash" = 'eeb13998c317dee9e55fda9c3d93f7c8f49e9388b8e605074fc6b3d2b1aacf41'
          ...
          AND run_row."promptHash" = 'd19fcc5fbf32bb8859f47f8dbbf1a5bcbcc4a7cfa496b7d8375b8e8f318810d7'
        )
      )
