    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.10'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '2e700b218fafd296ce76dda1db266acbe2e1fe13684b9e17519c149d5058bbb3'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.10'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = 'c7f7994ebb17e364e4adb7cfa8782ba395966926f426be267664427d505a4193'
        ) OR (
          ...
          AND run_row."workflowHash" = 'f2021c6729be59a99c57108d3b966dd63cae1f2fe8ae1a0f097885079526db70'
          ...
          AND run_row."promptHash" = '7738c56660946f6036c10cdbd170bc7ccf27cebffdc58881df6ee7ea5e30b640'
        )
      )
