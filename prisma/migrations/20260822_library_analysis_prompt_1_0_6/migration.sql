    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.6'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '54cf0863be9e296cced7c78fd95e30cad75ed65b15abc974334ad1abc2936fa5'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.6'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = 'a8ceafb79d410a77aa3a78e21b8a1b00bfe80012840fc6ec75f039050cd19d2d'
        ) OR (
          ...
          AND run_row."workflowHash" = 'f9c76555884bd846df536179a452605056165922235ea663a98c298688011829'
          ...
          AND run_row."promptHash" = 'a5c2a06e8c76c92058ca830181add7b38fa7ddbfd28d8272a5cc36e45a263346'
        )
      )
