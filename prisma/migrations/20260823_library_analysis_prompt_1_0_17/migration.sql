-- Advance the sealed library analysis and validation bindings to 1.0.17
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.17'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '78a0cc569372c06061c49a27584541ddd051c92d0ec718da6a385194cc24d855'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.17'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '039803b735457cc3b18c6993dc4a5990d5e4891ab27d7697b68e8b4c1c1a3e76'
        ) OR (
          ...
          AND run_row."workflowHash" = '7cce0e2ac4f08aa54ad72360a90fe73f29cf59746d5916c6edbad6f3779d0791'
          ...
          AND run_row."promptHash" = '55a73e7612a2127f5fc509c78e431b554e488b57a09dab451d587a203bf00c22'
        )
      )
