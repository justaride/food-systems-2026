-- Advance the sealed library analysis and validation bindings to 1.0.16
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.16'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '0f04ac2b2ae5e2650d4ecfd42ad5a47d2dfb9d2b7960db3c96cf537080c5372c'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.16'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '4c8195988c162c21f6a934041e36173d34c31664cca175580388e869a255c317'
        ) OR (
          ...
          AND run_row."workflowHash" = '18e3ba091f0339b4b7599b744241c1f43ba130065ec4ac7946d68ca2e4d54a29'
          ...
          AND run_row."promptHash" = '807664d2724d5534bcfbdce1a9cb26c876a8ba72d1d2ef92b1c5905332d1bb66'
        )
      )
