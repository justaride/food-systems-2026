    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.8'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = 'cd8dfb10366cd80eb2039b4489827391b7dea4ba3473d7761e5c224de309261e'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.8'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '3809e9a7c6745c0751087d9f5b964a1c2d108797bd3b4d6d3290975ac269820b'
        ) OR (
          ...
          AND run_row."workflowHash" = 'a7a6ef7dfdf9acf0aa58eda5c67a18f6521fefb2d81e18628516880a74304dbe'
          ...
          AND run_row."promptHash" = '4661bc32619ce2c9104640162c8afff0206ad737deee980c7165c50fcae9c07f'
        )
      )
