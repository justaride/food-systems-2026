-- Advance the sealed library analysis and validation bindings without rewriting
-- the historical candidate-analysis foundation migration.
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.14'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = 'fd4cbf6c12e40a6b302a3caf62fa60986e938eb1dd212fa602d3f210563ef6ca'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.14'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '591680b5e8479d7b3516943efe7ca584ff6d09a215777c4802df306e529f7a76'
        ) OR (
          ...
          AND run_row."workflowHash" = 'ec58986b0f0bf3a65794c83034ed7a13d011fa2109a915ad9c515beb3456ebc5'
          ...
          AND run_row."promptHash" = '5ff25f83dd4cf02795ee63531afad4ed038b1caf676ead0f51e8235e0d459ae9'
        )
      )
