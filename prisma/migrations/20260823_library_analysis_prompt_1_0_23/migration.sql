-- Advance the sealed library analysis and validation bindings to 1.0.23
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.23'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '6cf060374095c957622f85e564cb4a54289204771b48d4a089ca9caf7d4232ec'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.23'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '9102479172020252a62c5d8cce4762872ab97f8b2b077adad2382bcf685340e3'
        ) OR (
          ...
          AND run_row."workflowHash" = '71e2e5a9ff4ca20bd2b4c87d305b34f20426c11e7c4d467e203771ac9ee25acc'
          ...
          AND run_row."promptHash" = '82f61c3911262c110eb281d95a2378153001e69a71ce6d573415511b899f1f87'
        )
      )
