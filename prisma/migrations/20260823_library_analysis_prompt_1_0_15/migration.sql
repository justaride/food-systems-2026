-- Advance the sealed library analysis and validation bindings to 1.0.15
    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.15'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '4ee2f5f017602353b384d898b48d82a2f9261fca72e3b0a7ef408215b91b3b0a'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.15'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = '9cc93555f5a200b0acf9e3e46af458700e7ee7bf867eb3da0f3f17e277a4501a'
        ) OR (
          ...
          AND run_row."workflowHash" = '42408aab9b18ba654e6203932e55eeb025d527190601c8843a4a9d31a321b5f1'
          ...
          AND run_row."promptHash" = 'f17588476b69b5e0b4fbb1ac59939deaa81cddd87ab0890d9c1b704c2ca2e3c7'
        )
      )
