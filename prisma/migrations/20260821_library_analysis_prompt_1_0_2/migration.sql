    ...
    IF run_row.id IS NULL OR run_row.id !~ '^[a-z0-9][a-z0-9._:-]*$'
      ...
      OR NOT (
        (
          ...
          AND run_row."workflowVersion" = '1.0.2'
          AND run_row."workflowPath" = 'knowledge/corpus/workflows/library-analysis-automated-v1.md'
          AND run_row."workflowHash" = '005bf4475d4b1fd4176d786500fcba8d3b91bbc72860c6dc0d19b86057f8c2b5'
          AND run_row."promptId" = 'prompt.library_analysis.automated.v1'
          AND run_row."promptVersion" = '1.0.2'
          AND run_row."promptPath" = 'knowledge/corpus/workflows/library-analysis-automated-prompt-v1.md'
          AND run_row."promptHash" = 'fbe0d7b2fb08f12091ad3b54090cc309dbae279dbca142ad675db00223588cd9'
        ) OR (
          ...
          AND run_row."workflowHash" = '2b51f70e460659500dbf6dc2d17454924fb3dffdba1b56aa79e5d02da815470b'
          ...
          AND run_row."promptHash" = '53ecb40e35bcc4d074a9088051529265cfba274be0c139263dc993e2a4e70351'
        )
      )
