...
- NACE: 10.710 — Produksjon av brød og ferske konditorvarer
...
- Finn Torstein Dybvik — styremedlem
- Geir Alsaker — styremedlem
- Heidi Dahl — styremedlem
- Heidi Gaaren — styremedlem
- Kjell Arne Ness — styremedlem
- Kristine Stranne — styremedlem
- Oyvind Andersen — styreleder
- Roar Bakkejord — styremedlem
- Stine Sæther — styremedlem
- Thomas Kvissellien — styremedlem
- Ulrikke Nilsen — styremedlem
- Øystein Halvorsen — CEO

## Forsyningskjede

- supplier → [[Coop Norge SA]] — Bakehuset leverer brød og bakerivarer til Coop Norge
- supplier → [[Reitan Retail AS]] — Bakehuset leverer brød og bakerivarer til REMA 1000
