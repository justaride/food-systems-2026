...
- NACE: 10.850 — Produksjon av ferdigmat
...
- [[Orkla Home and Personal Care AS]] — 100 % (subsidiary)
- [[Orkla IT AS]] — 100 % (subsidiary)
- [[Orkla Eiendom AS]] — 100 % (subsidiary)
- [[Pierre Robert Group AS]] — 100 % (subsidiary)
- [[Orkla Food Ingredients AS]] — 60 % (subsidiary)
...
- [[Orkla Foods AS]] (100 %)
  - [[Orkla Foods Norge AS]] (100 %)
- [[Orkla Health Holding AS]] (100 %)
  - [[Orkla Health AS]] (100 %)
- [[Orkla Home and Personal Care AS]] (100 %)
  - [[Orkla House Care Norge AS]] (100 %)
- [[Orkla IT AS]] (100 %)
- [[Orkla Snacks AS]] (100 %)
  - [[Orkla Snacks Norge AS]] (100 %)
- [[Pierre Robert Group AS]] (100 %)

## Styreverv

- Bengt Arve Rem — styremedlem
- Caroline Marie Kjos — styremedlem
- Christina Thérèse Hersch Fagerberg — styremedlem
- Hans Peter Henrik Agnefjäll — styremedlem
- Ingrid Sofie Nielsen — styremedlem
- Liselott Kilaas — styremedlem
- Nils Selte — CEO
- Roger Vangen — styremedlem
- Rolv Erik Ryssdal — styremedlem
- Stein Erik Hagen — styreleder
- Terje Utstrand — styremedlem
