...
export const meetings: Meeting[] = [
  ...
  },
  {
    ...
    summary: 'Strategisk mote der roller og leveranser ble avklart for Food Systems og Cities. Cathrine er fagleder Food, Gabriel har data/plattform, Jan Thomas er prosjektleder Cities. Hovedleveranse er 20-siders mini-whitepaper + presentasjon til lanseringsevent i juni. 250k-fasen skal forberede soknad pa 2,5M for 3-arig prosjekt. Diskuterte nordisk dimensjon, sirkularitetskobling, eiendomsmodeller i dagligvare, og politisk timing. Ten Step Start v2.0 skal revideres for videre arbeid.',
    keyDecisions: [
