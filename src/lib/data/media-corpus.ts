...
export const mediaEntries: MediaEntrySeed[] = [
  ...
  },
  {
    ...
    summary:
      'USDA GAIN komprimerer islandsk dagligvarestruktur til et sammenliknbart notat og er nyttig som sekundaer kryssjekk av Hagar, Festi og Drangar-dynamikken.',
    recordType: 'market-report',
    verificationLevel: 'secondary',
    triggerLabel: 'USDA Iceland retail foods',
    sourceDocId: 'src-85',
    sourceRefs: [
