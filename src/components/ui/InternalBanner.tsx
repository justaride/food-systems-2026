...
export function InternalBanner({ note, label }: InternalBannerProps) {
  return (
    <div className="rounded-md border border-amber-200 bg-amber-50 px-4 py-2.5">
      <p className="text-[10px] font-semibold uppercase tracking-wider text-amber-700">{label ?? 'Intern arbeidsflate'}</p>
