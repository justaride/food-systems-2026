...
export default function FoodDesertPanel() {
  ...
  return (
    <div className="absolute bottom-24 left-4 right-4 sm:bottom-auto sm:left-auto sm:top-4 z-[1000] w-auto sm:w-64 max-h-[45dvh] overflow-y-auto bg-white rounded-xl border border-stone-200/80 shadow-sm overflow-hidden">
