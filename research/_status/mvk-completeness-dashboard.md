...
| innsatsfaktorer | 34 | 80 | 43% | 1/4 | 20 |
...
- `innsatsfaktorer` har naa 34/80 kartlagt og 1/4 celler mettet. `froe-genressurser` har gap 7; `for-protein` importerte/beriket 22 noder hvor 21 teller i NO-raden og `Cargill Aqua Nutrition / EWOS` teller som `US` fordi eksisterende Actor-country er US. Resterende input-hull er `gjodsel-jordforbedring` og `biostimulanter-jordliv`.
