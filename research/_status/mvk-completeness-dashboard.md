...
| matsvinn-sirkulaer | 65 | 120 | 54% | 1/6 | 20 |
...
- `matsvinn-sirkulaer` har naa 65/120 kartlagt og 1/6 celler mettet. Neste sirkulaere hull er `emballasje-retur`, videre metning av `insekt-alternativ-protein`, `kompost-jordprodukt`, `matredistribusjon` og siste node for `biogass-bioraffinering`.
