...
| matsvinn-sirkulaer | 35 | 120 | 29% | 0/6 | 20 |
...
- Hele v2-spinen er fortsatt tidlig i metningsloopen. `matsvinn-sirkulaer / matredistribusjon` er forbedret, `matsvinn-sirkulaer / biogass-bioraffinering` er nesten mettet med gap 1, og `matsvinn-sirkulaer / insekt-alternativ-protein` har faatt en forste kildebelagt kjerne paa 6 noder.
...
- `matsvinn-sirkulaer` har naa 35/120 kartlagt; neste sirkulaere hull er `reststrom-sidestrom`, `kompost-jordprodukt`, `emballasje-retur` og videre metning av `insekt-alternativ-protein`.
